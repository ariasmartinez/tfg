...
void drawScene()
{
    ...
    if (gHapticManager->getManipulationStyle() == IHapticDeviceManager::FREE_MANIPULATION) {
        gHapticManager->drawCursor();
    }
  
    else {
        // Podemos ponerle un atributo a gHapticManager que sea los puntos que se tienen que dibujar
...
void glutMenu(int value)
{
    ...
    case IHapticDeviceManager::FREE_MANIPULATION:
        ...
        break;
    case IHapticDeviceManager::FORCE_MANIPULATION:
        gHapticManager->setManipulationStyle(value);
        gHapticManager->results.close();
        gHapticManager->results.open("force.csv");
        gHapticManager->results << "x,y,color,target,time\n";
        break;
    case IHapticDeviceManager::NOFORCE_MANIPULATION:
        gHapticManager->setManipulationStyle(value);
        gHapticManager->results.close();
        gHapticManager->results.open("no_force.csv");
        gHapticManager->results << "x,y,color,target,time\n";
        break;
    case IHapticDeviceManager::FORCE_MANIPULATION_NOCURSOR:
        gHapticManager->setManipulationStyle(value);
        gHapticManager->results.close();
        gHapticManager->results.open("force_no_cursor.csv");
        gHapticManager->results << "x,y,color,target,time\n";
        break;
    case IHapticDeviceManager::NOFORCE_MANIPULATION_NOCURSOR:
        gHapticManager->setManipulationStyle(value);
        gHapticManager->results.close();

        gHapticManager->results.open("no_force_no_cursor.csv");
        gHapticManager->results << "x,y,color,target,time\n";
        break;
    case 6:
        exit(0);
...
int main(int argc, char* argv[])
{
    ...
    glutAddMenuEntry("Force Manipulation",
        IHapticDeviceManager::FORCE_MANIPULATION);
    glutAddMenuEntry("No Force Manipulation",
        IHapticDeviceManager::NOFORCE_MANIPULATION);
    glutAddMenuEntry("Force Manipulation No Cursor",
        IHapticDeviceManager::FORCE_MANIPULATION_NOCURSOR);
    glutAddMenuEntry("No Force Manipulation No Cursor",
        IHapticDeviceManager::NOFORCE_MANIPULATION_NOCURSOR);
